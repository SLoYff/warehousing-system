...
namespace CamDLLHelper
{
    public class CamDLL
    {
        ...
        /// 
        /// <returns></returns>
        [DllImport("CmCapture.dll", EntryPoint = "camSetPreviewWindow", CallingConvention = CallingConvention.Cdecl)]
        public static extern int SetPreviewWindow(int devIndex, IntPtr hPreviewWindow);
